    ...
    return (
      <div className={"app"}>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            Ao continuar, você concorda que alguns dados serão armazenados no navegador para melhorar a sua experiência, análise de dados, correção de erros e descoberta de bugs.
          </motion.div>
        </AnimatePresence>
      </div>
    )
